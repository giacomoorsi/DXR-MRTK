...
namespace DxR
{
    ...
    public class GUI : MonoBehaviour
    {
        ...
        private void InitInteractiveButtons()
        {
            ...
            //APO
            //Microsoft.MixedReality.Toolkit.Input.IMixedRealityTouchHandler zoomOutBtn2 = 
            //    gameObject.transform.Find("ZoomOutButton").GetComponent<Microsoft.MixedReality.Toolkit.Input.IMixedRealityTouchHandler>();
            //zoomOutBtn2.onTouchCompleted.AddListener(ZoomOutCallback);
...
/*
        ...
        private void AddChannelGUIDeleteCallback(ref GameObject channelGUI)
        {
            ...
            btn.onClick.AddListener(() => DeleteParentOfClickedObjectCallback(btn.gameObject));
        ...
        private void DeleteParentOfClickedObjectCallback(GameObject el)
        {
            Debug.Log("Clicked " + el.transform.parent.name);
            //
            //GameObject.Destroy(EventSystem.current.currentSelectedGameObject.transform.parent.gameObject);
            GameObject.Destroy(el.transform.parent.gameObject);
        }
