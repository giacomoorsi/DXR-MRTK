...
namespace Microsoft.MixedReality.Toolkit.Utilities.Solvers
{
    ...
    /// </summary>
    public class TapToPlaceParent : Solver, IMixedRealityPointerHandler
    {
        [Space(10)]
        [SerializeField]
        ...
        public void StartPlacement()
        {
            ...
            if (!IsBeingPlaced)
            {
                ...
                //GameObjectLayer = gameObject.layer; APO
                GameObjectLayer = gameObject.transform.parent.gameObject.layer;

                // Temporarily change the game object layer to IgnoreRaycastLayer to enable a surface hit beyond the game object
                // APO gameObject.layer = ignoreRaycastLayer;
                gameObject.transform.parent.gameObject.layer = ignoreRaycastLayer;
        ...
        public void StopPlacement()
        {
            ...
            if (IsBeingPlaced)
            {
                ...
                // APO gameObject.layer = GameObjectLayer;
                gameObject.transform.parent.gameObject.layer = GameObjectLayer;
